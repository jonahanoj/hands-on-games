function unitClass() {
    ...
    this.keepInPlayableArea = function() {
        if(this.gotoX < UNIT_PLAYABLE_AREA) {
            this.gotoX = UNIT_PLAYABLE_AREA;
        } else if(this.gotoX > canvas.width - UNIT_PLAYABLE_AREA) {
            this.gotoX = canvas.width - UNIT_PLAYABLE_AREA;
        }

        if(this.gotoY < UNIT_PLAYABLE_AREA) {
            this.gotoY = UNIT_PLAYABLE_AREA;
        } else if(this.gotoY > canvas.height - UNIT_PLAYABLE_AREA) {
            this.gotoY = canvas.height - UNIT_PLAYABLE_AREA;
        }
    }
    ...
    this.draw = function () {
        circle(this.x, this.y, UNIT_PLACEHOLDER_RADIUS, this.unitColor);
    }
